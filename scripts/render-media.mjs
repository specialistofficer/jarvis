...
function artwork(spec, width, height, focus, detail, index = 0) {
  ...
  return `<svg xmlns="http://www.w3.org/2000/svg" width="${width}" height="${height}" viewBox="0 0 ${width} ${height}">
    ...
    <g opacity=".13" transform="translate(${width * .65} ${height * .55})"><path d="M0 0 C55 -80 150 -80 205 0 L250 330 H-45Z" fill="#2f7040"/><path d="M65 -38 C82 -85 123 -85 140 -38" fill="none" stroke="#2f7040" stroke-width="18" stroke-linecap="round"/><path d="M70 55h75v115H70z" fill="#b9ef62"/><circle cx="107" cy="112" r="18" fill="#f7faf3"/></g>
